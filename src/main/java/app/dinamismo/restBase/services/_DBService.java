...
import app.dinamismo.restBase.domain.PagamentoComCartao;
...
public class _DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Betina", "silvajfersonluis@hotmail.com", "36378912377", TipoCliente.PESSOAFISICA, bCryptPassword.encode("123"));
		
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Jeferson", "silvajefersonluis@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, bCryptPassword.encode("123"));
